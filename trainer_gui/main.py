...
# Repo root = parent of the trainer_gui/ project dir (where modal_train_*.py live).
...
PAGES = ["Datasets", "Pretraining", "Train", "Runs", "Plotting", "Inference"]
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        sl.addWidget(brand)
        tag = QLabel("point-cloud training on Modal")
        ...
        for page in (self.datasets_page, self.pretrain_page, self.train_page,
                     self.runs_page, self.plotting_page, self.infer_page):
